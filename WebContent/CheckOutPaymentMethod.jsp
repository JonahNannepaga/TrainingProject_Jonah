		...
		<!-- HEAD BEGINS-->
			<head>
				...
				<meta name="viewport" content="width=device-width,initial-scale=1">
					<title>CheckOutPaymentMethod</title>
		   ...
		   <!-- ROW2 Ending -->
			...
			<!-- ROW3 Starting -->
						...
						<div class="row" style="background-image:url('images/texture-bw.png');" >
								...
								<div class="col-md-7">
									<h2><b>CHECKOUT - PAYMENT METHOD</b></h2> 
								</div>
				
								<div class="col-md-3">
				 				<br>
									<p style="color:black">HOME / CHECKOUT-PAYMENT METHOD </p>
								</div>
								<br>
						 ...
						 <br/>
							...
							<div class="col-md-6">
									<button type="button" class="button1" style="height:40px;">
										REVIEW ORDER<span class="glyphicon glyphicon-chevron-right"></span>
									</button>
									</div>
								<br/>
								<br>		
