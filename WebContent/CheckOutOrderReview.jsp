		...
		<!-- HEAD BEGINS-->
			<head>
				...
				<meta name="viewport" content="width=device-width,initial-scale=1">
					<title>CheckOutOrderReview</title>
		   ...
		   <!-- ROW2 Ending -->
			...
			<!-- ROW3 Starting -->
						...
						<div class="row" style="background-image:url('images/texture-bw.png');" >
								...
								<div class="col-md-7">
									<h2><b>CHECKOUT - ORDER REVIEW</b></h2> 
								</div>
				
								<div class="col-md-3">
				 				<br>
									<p style="color:black">HOME / CHECKOUT-ORDER REVIEW </p>
								</div>
								<br>
				...
				<div class="col-md-3">
				 <div class="container-fluid">
					<div class="row"style="background-color: #F7F7F7;">
					   <h2 class="marginhead"><strong>ORDER SUMMARY</strong></h2>
					   <br>
					</div>				
				</div>
					<br>
